import { MessageSquare, Zap, Smartphone } from "lucide-react"
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-16 grid gap-6 md:grid-cols-3">
          ...
          <div className="group rounded-2xl border border-primary/20 bg-card/50 p-6 transition-all hover:border-primary/40 hover:bg-card md:p-8">
            ...
            <h3 className="text-xl font-semibold">Control From Any Browser</h3>
            <p className="mt-2 text-muted-foreground">
              Use your phone to control AR glasses. Control your computer from your tablet. One browser interface for
              everything.
            </p>
          </div>
        </div>
